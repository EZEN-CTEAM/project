  ...
  <main>
    <div class="main-container">
      ...
      <!-- 기업정보 요약 -->
        ...
        <section>
            <a href="#" class="apply_button" onclick="">지원하기</a>
        </section>
      </div>
    </div>
        ...
        <div class="modal_company">
          <div class="modal_company_container">
            ...
            <div class="modal_company_container_second">
              <div class="item_first">경력경력경력경력경력경력</div>
              <div class="item_second">희망직무희망직무직무직무</div>
            </div>
          </div>
          <div class="modal_company_container">
            <div class="modal_company_container_first">
            ...
            <div class="modal_company_container_second">
              <div class="item_first">희망지역희망지역희망지역</div>
              <div class="item_second">희망연봉희망연봉희망연봉</div>
            </div>
          </div>
        </div>
        <form action="recruitment_information_view.jsp" method="post">
          <div class="apply_detail_button">
            <input type="submit" value="지원" class="modal_apply">
            <input type="reset" value="취소" class="modal_cancle" onclick="location.href='<%= request.getContextPath() %>/jobPosting/jobView.jsp'">
          </div>
        </form>
      </div>
    </div>
