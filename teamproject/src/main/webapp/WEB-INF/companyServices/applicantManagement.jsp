  ...
  <main>
    ...
    <section class="board-container">
      <div class="apply_title">
        ...
        <a href="cjobList1.jsp">더보기 ></a>
      </div>
      <div class="apply_list">
        <div>
          <a href="recruitment_information_view.jsp">
            ...
            <div class="company_button">
              <a href="cjobModify.jsp" class="button_area">수정</a>
          ...
          <div>
            <div class="apply_state_list">
              ...
              <div class="apply_state_function">
                <div class="function_item_1st"><a href="resume_view.jsp">이력서 보기</a></div>
