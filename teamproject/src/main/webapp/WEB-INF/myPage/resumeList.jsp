        ...
        <main>
            <div class="main-container7">
                ...
                <section class="resumeList">
                    <button class="write-button" onclick="location.href='resumeRegister.jsp'">이력서 작성</button>
                    <div class="resumeBoard" onclick="location.href='resumeView.jsp'">
                        <span>이력서 제목</span>
                        <span>..............</span>
                        <span>1</span>
                    </div>
                    ...
                    <div class="resumeBoard" onclick="location.href='resume_view.jsp'">
                        <span>이력서 제목</span>
                        <span>..............</span>
                        <span>3</span>
                        <div>학력</div>
