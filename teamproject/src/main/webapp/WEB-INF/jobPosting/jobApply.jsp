  ...
  <main>
    ...
    <div class="apply_modal">
      <div class="modal_content">
        ...
        <form action="recruitment_information_view.do" method="post">
          <div class="apply_detail_button">
            <input type="submit" value="지원" class="modal_apply">
            <input type="reset" value="취소" class="modal_cancle" onclick="location.href='<%= request.getContextPath() %>/jobPosting/jobView.do'">
          </div>
        </form>
      </div>
    </div>
