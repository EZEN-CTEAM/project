    ...
    <div class="main-container">
      <section class="search_contianer">
        <div class="search_result">
          <div style="font-weight: bold;">(검색어)</div><div>검색결과</div>
        </div>
      </section>
        ...
        <div class="company_container">
          ...
          <div class="commit_container">
            <div class="commit_info">
              <div>
                <div class="commit_info_score">평점 <img src="https://img.icons8.com/?size=100&id=87XmLcImcKSL&format=png&color=000000" width="17px"></div>
                <div class="commit_info_nickname">닉네임</div>
              </div>
              <div><a href="<%= request.getContextPath() %>/companyReview/reviewList.jsp" class="commit_info_detail">전체보기 ></a></div>
            </div>
            <div>
              <div class="commit_title">제목제목제목제목제목제목제목제목제목제목제목제목제목제목제목제목제목</div>
              <div class="commit_content">내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용</div>
            </div>
          </div>
        </div>
      </section>
          ...
          <div>
            <div class="free_container">
              <div class="free_list_container">
                <a href="<%= request.getContextPath() %>/freeBoard/freeView.jsp">
